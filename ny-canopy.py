...
for zip_area in wanted_zips:
  raw_data = project.clipRaster(name='cover-for-' + zip_area['properties']['ZCTA5CE10'], raster=tree_cover.image(), bounds=zip_area)
  pixels_tree_covered = len(raw_data[raw_data == TREE_COVER_INDEX])
  zip_area['properties']['TREE_PERCENT'] = pixels_tree_covered / raw_data.size
